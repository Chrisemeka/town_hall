        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-8 py-16 lg:py-20">
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between gap-12 pb-12 lg:pb-16">
            ...
            <div className="flex flex-col gap-5 max-w-sm">
              ...
              <p className="font-mono text-[#F0F0F2]">Contact us: <a tabIndex={0} href="mailto:twnhallhq@gmail.com" className="text-voltage underline hover:overline">twnhallhq@gmail.com</a></p>
